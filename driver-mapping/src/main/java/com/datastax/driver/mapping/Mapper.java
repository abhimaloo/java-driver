...
public class Mapper<T> {
    ...
    ListenableFuture<PreparedStatement> getPreparedQueryAsync(QueryType type, Set<AliasedMappedProperty> columns, EnumMap<Option.Type, Option> options) {
        ...
        if (existingFuture == null) {
            ...
            if (old != null) {
                ...
                final String queryString = type.makePreparedQueryString(tableMetadata, mapper, manager, columns, options);
    ...
    public static abstract class Option {
        ...
        enum Type {TTL, TIMESTAMP, CL, TRACING, SAVE_NULL_FIELDS, IF_NOT_EXISTS, KEYSPACE}
        ...
        static class Keyspace extends Option {
            ...
            @Override
            void validate(QueryType qt, MappingManager manager) {
                // nothing to do, valid for all queries
            }
            ...
            @Override
            void modifyQueryString(BuiltStatement query) {
                // nothing to do (this option has to be handled with custom code in QueryType)
            }
            ...
            public boolean equals(Object other) {
                return other == this ||
                        (other instanceof Keyspace && MoreObjects.equal(this.keyspace, ((Keyspace) other).keyspace));
            }
